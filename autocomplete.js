	...
	$.fn.autocomplete = function(options){
		...
		function setDropdownContent(value, data){
			...
			matchStr.forEach(function(el){
				dropdown.append('<div tabindex="6" style="width:100%;padding:5px;cursor:pointer;border-bottom:1px solid #CCC;">'+ el +'</div>');
			});
			registerClick();
		}
		...
		function getMatchStr(value, data){
			...
			return data.filter(function(el){
				...
				return el.toLowerCase().indexOf(value.toLowerCase()) == options.searchIndex;
			});
		}
